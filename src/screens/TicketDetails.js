                ...
                <View style={styles.TicketDetailsContainer}>
                    ...
                    <View style={styles.TicketDetailsMainContainer}>
                        ...
                        <View style={styles.TicketDetailsMainItem}>
                            ...
                            <Text style={styles.TicketDetailsMainTextValue}>Connection Issue</Text>
                        </View>
                        <View style={styles.TicketDetailsMainItem}>
                            <Text style={styles.TicketDetailsMainText}>Created On</Text>
                            <Text style={styles.TicketDetailsMainTextValue}>17/08/2025,  04:04 PM</Text>
                        </View>
                        <View style={styles.TicketDetailsMainItem}>
                        ...
                        <View style={styles.TicketDetailsMainItem}>
                            ...
                            <Text style={styles.TicketDetailsMainTextValue}>BI - Tech Team</Text>
                        </View>
                    </View>
                </View>
